...
* [ ] I have checked the [Scope section of the README](https://github.com/leinardi/opencode-swap#scope) — this request is not load balancing/round-robin, a runtime proxy, Windows support, or reimplementing/modifying OpenCode itself.
...
* **Who benefits from this feature?** (e.g., all users, specific providers, specific platforms)
